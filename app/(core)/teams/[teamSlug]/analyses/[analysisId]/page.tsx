...
import { AnalysisOptions, AnalysisUnlock, RecentAnalysisVersion } from "./analysis-client";
      ...
      <Container
        breadcrumb={
          <ContainerBreadcrumb
            ...
            teamSlug={teamSlug}
            id={analysisId}
            toggle={<AnalysisOptions teamSlug={teamSlug} analysisId={analysisId} />}
          />
        }
      >
        ...
        <div className="max-w-5xl m-auto mt-8 lg:mt-16">
          <div className="flex flex-col gap-6 mb-8">
            <div className="flex justify-between items-start">
              <h1>{analysis.name}</h1>
              <Button asChild>
                <Link href={`/teams/${teamSlug}/analyses/${analysisId}/chat`}>
