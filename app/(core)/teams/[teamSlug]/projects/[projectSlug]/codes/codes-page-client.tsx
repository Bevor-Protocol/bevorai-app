...
import { codeActions, teamActions } from "@/actions/bevor";
...
const CodeVersionsData: React.FC<{
  ...
  const versionsQuery = useQuery({
    queryKey: generateQueryKey.codes(teamSlug, filters),
    queryFn: () => codeActions.getVersions(teamSlug, filters),
...
const Filters: React.FC<{
  ...
  const handleClearAll = useCallback(() => {
    ...
    setFilters(defaultCodesQuery(projectSlug));
