...
import { defaultTeamAnalysesQuery } from "@/utils/queries";
import { keepPreviousData, useQuery } from "@tanstack/react-query";
import { Plus, Search } from "lucide-react";
import React, { useCallback, useEffect, useMemo, useRef, useState } from "react";

export const AnalysisCreate: React.FC<{ teamId: string }> = ({ teamId }) => {
  return (
    <Dialog>
      ...
      <DialogContent>
        <CreateAnalysisModal teamId={teamId} />
      </DialogContent>
    </Dialog>
  );
};
...
const Filters: React.FC<{
...
}> = ({ teamId, filters, setFilters, isAnySearched, setIsSearching }) => {
  ...
  const handleClearAll = useCallback(() => {
    ...
    setFilters(defaultTeamAnalysesQuery());
