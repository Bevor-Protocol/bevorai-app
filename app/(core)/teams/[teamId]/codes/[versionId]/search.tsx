...
const NodeSearch: React.FC<{
  ...
  const {
    ...
    queryKey: [QUERY_KEYS.CODES, versionId, "nodes", { name: debouncedState }],
    queryFn: () => versionActions.searchNodes(teamId, versionId, { name: debouncedState }),
          ...
          {!!search &&
            ...
            results?.map((result) => (
              <div
                ...
                onClick={() =>
                  handleSelection({
                    sourceId: result.instance_source_id,
