...
export const ChatPagination: React.FC<{ teamId: string; page: string; basePath: string }> = ({
  teamId,
  page,
  basePath,
}) => {
  ...
  const { data: chats, isLoading } = useQuery({
    queryKey: [QUERY_KEYS.CHATS, teamId, page],
    queryFn: () => chatActions.getChats(teamId, { page }),
  });
