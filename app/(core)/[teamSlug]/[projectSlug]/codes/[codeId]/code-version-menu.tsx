...
import { MoreHorizontal, Plus, Shield, Upload } from "lucide-react";
...
const CodeVersionMenu: React.FC<{
  ...
  const handleAnalysisCreated = (threadId: string): void => {
    setCreateDialogOpen(false);
    refetch();
    setSelectedAnalysisId(threadId);
  };
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex justify-end gap-2 pt-2">
                ...
                {selectedAnalysisId ? (
                  <Button asChild>
                    <Link
                      href={`/${teamSlug}/${projectSlug}/analysis-threads/${selectedAnalysisId}/nodes/new?codeVersionId=${version.id}`}
                    >
