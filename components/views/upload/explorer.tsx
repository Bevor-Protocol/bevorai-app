...
const ContractAddressStep: React.FC<{
  ...
  const scanData = mutation.data;
  const showOpeningAnalysis =
    mutation.isSuccess &&
    !!scanData?.analysis_id &&
    (scanData.status === "waiting" ||
    ...
    <>
      <DialogHeader>
        <div className="flex items-center gap-3">
          <Globe className="size-5 shrink-0 text-purple-400" aria-hidden />
          <DialogTitle>Explorer scan</DialogTitle>
        </div>
        <DialogDescription>
