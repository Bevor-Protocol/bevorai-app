    ...
    >
      ...
      <div className="space-y-8">
        <div className="flex items-start gap-4">
          ...
          <div>
            <h3 className="text-xl font-semibold">Initial Development</h3>
        ...
        <div className="flex items-start gap-4">
          <CheckCircle2 className="size-6 text-cyan-400 mt-1 shrink-0" />
          <div>
            <h3 className="text-xl font-semibold">Twitter Launch</h3>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            <h3 className="text-xl font-semibold">AI Improvements</h3>
            <p className="text-gray-400">
        ...
        <div className="flex items-start gap-4">
          <Circle className="size-6 text-cyan-400 mt-1 shrink-0" />
          <div>
            <h3 className="text-xl font-semibold">Analysis Submission System</h3>
            <p className="text-gray-400">
